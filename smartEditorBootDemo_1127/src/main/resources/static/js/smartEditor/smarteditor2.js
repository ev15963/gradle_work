	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				// javateacher
				linkNode.href = sCSSBaseURI + '/smartEditor/smart_editor2_in.css';
...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		console.log("####### this.htOptions.sCSSBaseURI : "+this.htOptions.sCSSBaseURI); // javateacher
		
		// javateacher
		nhn.husky.SE2M_Utils.loadCSS(this.htOptions.sCSSBaseURI+"/smartEditor/smart_editor2_items.css", fnCallback);
